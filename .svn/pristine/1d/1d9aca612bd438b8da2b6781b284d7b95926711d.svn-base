...
class CoreCentralManager:NSObject, CBCentralManagerDelegate, CBPeripheralDelegate {
    ...
    var finishUUID = CBUUID(string: "1D57D189-86B6-04EA-0B52-D24DC69207B9")
    ...
    */
    func connectTeacher(indexPath: Int) {
        self.centralManager.stopScan()
        self.centralManager.connectPeripheral(self.peripheralList[indexPath], options: nil)
    }
    ...
    */
    func login(studentInfo: StudentInfo) {
        ...
        // 書き込みを開始する
        self.peripheral.writeValue(sendData, forCharacteristic: sendCharacteristic, type: CBCharacteristicWriteType.WithResponse)
    ...
    */
    func sendAnser(questionAnswer: QuestionAnswer){
        ...
        // 書き込みを開始する
        self.peripheral.writeValue(sendData, forCharacteristic: self.characteristicList[self.answerUUID], type: CBCharacteristicWriteType.WithResponse)
    }
    ...
    */
    func sendFinish(){
        ...
        // 書き込みを開始する
        self.peripheral.writeValue(sendData, forCharacteristic: self.characteristicList[self.finishUUID], type: CBCharacteristicWriteType.WithResponse)
    }
    ...
    */
    func centralManager(central: CBCentralManager!, didDiscoverPeripheral peripheral: CBPeripheral!, advertisementData: [NSObject : AnyObject]!, RSSI: NSNumber!) {
        ...
        self.teacherNameList.append(peripheral.name as String?)
        ...
        for obj in characteristics {
            if let characteristic = obj as? CBCharacteristic {
                ...
                case answerUUID:
                    ...
                    println("anser")
                case finishUUID:
                    self.characteristicList.updateValue(characteristic, forKey: finishUUID)
                    println("finish")
                case quizStartUUID:
