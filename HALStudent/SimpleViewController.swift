...
class SimpleViewController: UIViewController, UIScrollViewDelegate, MenuViewDelegate, QCheckViewControllerDelegate, FinishFunctionDelegate, CorePeripheralManagerDelegate {
...
//    var studentData :StudentData!
    ...
    override func viewDidLoad() {
        ...
        *CoreDataの初期化
        *インスタンスの作成
        *StudentデーブルとQuestionデーブルの初期化
        */
        
        //CoreDataの初期化
//        coreData = CoreData_module()
//        coreData.add_Student()
        
        //問題数分のテーブル作成
//        for var i=0; i < QuestionBox.questionBoxInstance.selectQuestion.count; i++ {
//            println("呼ばれた回数：\(i)")
//            coreData.add_question(QuestionBox.questionBoxInstance.selectQuestion[i].id)
//        }
